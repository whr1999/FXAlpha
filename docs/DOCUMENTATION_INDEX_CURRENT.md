...
2. [`USER_GUIDE.md`](USER_GUIDE.md) and
...
3. [`BUSINESS_WORKFLOWS.md`](BUSINESS_WORKFLOWS.md) and
...
4. [`ARCHITECTURE.md`](ARCHITECTURE.md) — end-to-end module/data-flow diagram,
   boundaries, ownership, workflow, and
   architecture-audit findings.
5. [`SCREENSHOTS.md`](SCREENSHOTS.md) and
...
6. [`GITHUB_PUBLICATION_READINESS.md`](GITHUB_PUBLICATION_READINESS.md) — phase
   1–4 record, blockers, publication order, and later cutover plan.
7. [`GITHUB_UPLOAD_RUNBOOK.md`](GITHUB_UPLOAD_RUNBOOK.md) — exact fork-first,
   main-upload, GitHub-settings, fresh-clone, and first-release procedure.
8. [`LICENSE_POLICY_DECISION.md`](LICENSE_POLICY_DECISION.md) — current
   source-visible terms and decision boundary for external contributions.
9. [`VERIFICATION_REPORT_20260810.md`](VERIFICATION_REPORT_20260810.md) and
   ...
   evidence.
10. [`THIRD_PARTY_FORKS.md`](THIRD_PARTY_FORKS.md) — fork/submodule lifecycle.
11. [`VNPY_RETIREMENT.md`](VNPY_RETIREMENT.md) — execution decision and evidence.
12. [`LOCAL_DEPLOYMENT.md`](LOCAL_DEPLOYMENT.md) — isolated install and service
   template instructions.
13. [`SECURITY.md`](../SECURITY.md), [`SUPPORT.md`](../SUPPORT.md),
